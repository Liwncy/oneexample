...
public class MD4Util {
    ...
    public static String getMD4ofStr(String s) {
        return toHexString(mdfour(s.getBytes()));
    }

    public static void main(String[] args) {
        System.out.println(getMD4ofStr(""));
        System.out.println(getMD4ofStr("a"));
        System.out.println(getMD4ofStr("abc"));
        System.out.println(getMD4ofStr("message digest"));
        System.out.println(getMD4ofStr("abcdefghijklmnopqrstuvwxyz"));
        System.out.println(getMD4ofStr("ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789"));
        System.out.println(getMD4ofStr("123000"));
    }
